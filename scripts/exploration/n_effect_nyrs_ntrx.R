...
its <- 20    # how many times re-combine and iterate calculation?

n_uds_list <- list()

##
# udfiles     <- udfiles[24]
# udfilenames <- udfilenames[24]
# iaudfiles   <- iaudfiles[24]
...
filename <- paste0("figures/n_effects/nyrs_", asp, "_", asite, "_", "i", its, ".png")
ggsave(filename, plot = p_nyrs, width=7, height=7)

filename <- paste0("figures/n_effects/ntrx_", asp, "_", asite, "_", "i", its, ".png")
